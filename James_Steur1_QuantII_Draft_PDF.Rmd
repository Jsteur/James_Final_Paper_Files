...
4). The dependent variable should not include outliers. If the dependent has outliers, this affects the skew of the distribution, which influences the mean of the data. If the mean of the data is greatly affected, then the mean will be biased. 

In my data set, there are no outliers in the dependent variable. All students received similar scores to one another.  
