...
stargazer(summary=FALSE, header=FALSE, type = "latex", title = "Pooled Classes Paired Sample               T-Test 1",notes = "DF=25. Two-tailed test.", Table_2)
```
...
```{r, echo=FALSE, results="asis"}
colnames(Table_3) <- c("Class & Level", "95% CI", "t-statistic", "p-value", "Mean Difference") 
...
```{r, echo=FALSE, results="asis"}
colnames(Table_4) <- c("Level", "95% CI", "Permutation p-value", "Cohen's d", "Error Rate", "Power") 
