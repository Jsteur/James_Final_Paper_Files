...
##Level 
counts3 <- table(s15comments$Class, s15comments2$Level)
barplot(counts3, main="Figure 2: Frequency of Level Comments For Class 1 & 2",
  xlab="Level of Comment", col=c("darkblue","red"),
 	ylim=c(0,140), legend = rownames(counts3), beside=TRUE)
rownames(counts3) <- c("Professor 1", "Professor 2")
