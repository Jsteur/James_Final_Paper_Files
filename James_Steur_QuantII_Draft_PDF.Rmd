...
stargazer(summary=FALSE, header=FALSE, type = "latex", title = "Overall Means, Ranges, and Coverage Intervals", notes = "Paper 1 and 2=Professor 1. Paper 3 and 4=Professor 2.", Overall_Table)
```
```{r, echo=FALSE, results="asis"}
##Summarize Variables of Interest.

stargazer(summary=FALSE, header=FALSE, type = "latex", title = "Overall Means, Ranges, and Coverage Intervals", notes = "Paper 1 and 2=Professor 1. Paper 3 and 4=Professor 2.", Macro_Table)
```
...
```
I've identified that students receiving comments on their papers improve by the end of the class. That is, there are clearly identifiable effects we can observe when pooling all the students together, but what is causing this improvement in the final papers? Given the observational nature of this data, it is impossible to entirely rule out confounding varibals and other factors that could influence the results. However, it's worth investigating the differnt approaches both professors took when they commented on all of their papers since I rejected the null hypothesis for Class 1 Overall. 

First, there is a noticeable difference in the primary ways that professors one and two comment in terms of their purpose. Professor one has a high frequency of praising his or her students. A praising comment would indicate that the professor approves of a choice in the student's writing, which may or may not include an additional suggestion. For example, a comment that praises would say something like, "Good work! I enjoy your transition sentence." Professor two, on the other hand, primarily relies on advising by giving general feedback without making a specific correction. Some examples of advising would be, "This paragraph would be more compelling if you discussed the counterargument more," or "you should delete this sentence." Both professors had roughly equal levels of problem detecting purpose comments. Generally, these comments took the form of "This isn't accurate."

```{r}
counts1 <- table(s15comments$Class, s15comments2$Purpose)
barplot(counts1, main="Frequency of Purpose Comments For Class 1 & 2",
  xlab="Purpose of Commenting", col=c("darkblue","red"),
 	ylim=c(0,100), legend = rownames(counts1), beside=TRUE)

##Style 
counts2 <- table(s15comments$Class, s15comments2$Style)
barplot(counts2, main="Frequency of Style Comments For Class 1 & 2",
  xlab="Style of Commenting", col=c("darkblue","red"),
 	ylim=c(0,120), legend = rownames(counts2), beside=TRUE)
```
...
Second, Professor one's style of commenting was primarily evaluative. This style of commenting evaluates the writing quality as "good" or "bad." Professor one may write something like, “This paper is great and needs little revision!” One important aspect to note is that professor one primarily relied on positive evaluation. Although there were some negative aspects, most of the comments that researchers coded were positive evlauations. Professor two's style of commenting was primarily a directive approach. This style of commenting advises students to make a change in their writing without directly making the change. For instance, a comment like, “In future papers, you should develop your thesis more,” would be a directive. 

I have created Figure 1 to highlight the stark differences in the purpose and style of each professors commenting. 
