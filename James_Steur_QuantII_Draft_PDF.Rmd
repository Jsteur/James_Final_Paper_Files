...
Conventionally, an effect size of 0.8 is considered large, 0.5 is medium, and 0.2 is small. Put differently, seeing an effect size of 0.2 is usually something you can only see with careful study, whereas an effect size of 0.8 is high enough for someone to see the effects with the naked eye. The effect size largely depends on context. For example, seeing an effect size of 0.2 may usually be considered small, but it may be large if the effect is observed in preventing suicide. Context and expertise is important when interpreting the different effect sizes. 
