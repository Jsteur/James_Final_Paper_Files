...
In order to find the effect size for the two different classes and their respective outcome variables, I used Hedges' g. One reason I chose Hedges' g are my sample sizes. When n<20, Hedges' g produces less biased effect sizes since it divides the difference in means by the pooled and weighted standard deviations of the sample. Dividng by the pooled and weighted standard deviation helps account for the small sample size by getting a more precise measure of the standard deviation of the small sample and helps remove a small positive bias (Hedges, 1981). If I were to use Cohen's d for these different calculations, the effect sizes could be more positvely biased given the small sample sizes. Moreover, Hedges' g assumes that the variences of both populations are equal, and they are in my data. 
```{r, results="hide", include=FALSE}
