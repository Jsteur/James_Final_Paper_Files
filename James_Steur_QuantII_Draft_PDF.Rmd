...
These resultsThis could suggest that professor 1 is giving comments which are indicating greater improvement in the overall papers, and professor 2 is giving comments that are resulting in less improvement in a statistically signficant way. However, given my low power rates it's highly possible there is an effect going on with the second batch of students. 
```{r, echo=FALSE, results="asis"}
...
In summation, look at table X and Y for a summary of all the scores.  here are all means, ranges, and 50% coverage intervals for the overall quality of the paper. The mean scores for papers 1, 2, 3, and 4 respectively are 2.125, 2.625, 2, and 2.5. The ranges for papers 1, 2, 3, and 4 are 1-3, 2-4, 1-3, and 1-3 respectivley. The 50 percent coverage intervals for papers 1, 2, 3, and 4 respectively are 2–3, 2–3, 2–2, and 2–3. For macro quality of the paper, the mean scores for papers 1, 2, 3, and 4 respectively are 2.25, 2.69, 2, and 2.5. The ranges for papers 1, 2, 3, and 4 are 1-4, 2-4, 1-3, and 1-3. The 50% coverage interval for 
```{r, echo=FALSE, results="asis"}
