...
```{r, echo=FALSE, results="asis"}
stargazer(summary=FALSE, header=FALSE, type = "latex", float.env = "sidewaystable", title = "Separate Classes Paired Sample T-Test 2", notes = "Class 1 DF=15. Class 2 DF=9. Two-tailed test for both classes.", Table_4)
```
