...
#==Fix later.
stargazer(summary=FALSE, header=FALSE, float.env = "sidewaystable", type = "latex", title = "Pooled Classes Paired Sample T-Test 2",notes = "DF=25. Two-tailed test.", Table_2)
```{r, results="hide", include=FALSE}
